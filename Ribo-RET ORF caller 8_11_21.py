...
novel_leaderless_ORFs_1_nt = [] #novel ORFs from TSS analysis  with a TSS 1 nt upstream of an RTG
novel_leaderless_ORFs_2_nt = [] #novel ORFs from TSS analysis  with a TSS 1 nt upstream of an RTG
novel_leaderless_ORFs_3_nt = [] #novel ORFs from TSS analysis  with a TSS 1 nt upstream of an RTG
    ...
    if len(line.split()) == 9: #only consider TSSs with a potential ORF nearby
        ...
        if line.split()[8] == 'Novel':
            ...
            if int(line.split()[3]) == 1:
                novel_leaderless_ORFs_1_nt.append([line.split()[0], int(line.split()[4]), int(line.split()[5])]) #strand, start, stop
            if int(line.split()[3]) == 2:
                novel_leaderless_ORFs_2_nt.append([line.split()[0], int(line.split()[4]), int(line.split()[5])]) #strand, start, stop
            if int(line.split()[3]) == 3:
                novel_leaderless_ORFs_3_nt.append([line.split()[0], int(line.split()[4]), int(line.split()[5])]) #strand, start, stop
...
"""
x = lineplot_for_a_single_input_file(novel_leaderless_ORFs_1_nt, 1, 0, 50, 100, 0.3, list_of_coverage_gff_filenames_both_reps, list_of_labels_both_reps, 'Position Relative to Start Codon (nt)', 'Normalized Read Depth', 'leaderless_1_nt_novel_starts_ret_2reps', 'Oranges_r')
x = lineplot_for_a_single_input_file(novel_leaderless_ORFs_1_nt, 2, 0, 100, 50, 0.3, list_of_coverage_gff_filenames_both_reps, list_of_labels_both_reps, 'Position Relative to Stop Codon (nt)', 'Normalized Read Depth', 'leaderless_1_nt_novel_stops_ret_2reps', 'Oranges_r')

x = lineplot_for_a_single_input_file(novel_leaderless_ORFs_2_nt, 1, 0, 50, 100, 0.3, list_of_coverage_gff_filenames_both_reps, list_of_labels_both_reps, 'Position Relative to Start Codon (nt)', 'Normalized Read Depth', 'leaderless_2_nt_novel_starts_ret_2reps', 'Oranges_r')
x = lineplot_for_a_single_input_file(novel_leaderless_ORFs_2_nt, 2, 0, 100, 50, 0.3, list_of_coverage_gff_filenames_both_reps, list_of_labels_both_reps, 'Position Relative to Stop Codon (nt)', 'Normalized Read Depth', 'leaderless_2_nt_novel_stops_ret_2reps', 'Oranges_r')

x = lineplot_for_a_single_input_file(novel_leaderless_ORFs_3_nt, 1, 0, 50, 100, 0.3, list_of_coverage_gff_filenames_both_reps, list_of_labels_both_reps, 'Position Relative to Start Codon (nt)', 'Normalized Read Depth', 'leaderless_3_nt_novel_starts_ret_2reps', 'Oranges_r')
x = lineplot_for_a_single_input_file(novel_leaderless_ORFs_3_nt, 2, 0, 100, 50, 0.3, list_of_coverage_gff_filenames_both_reps, list_of_labels_both_reps, 'Position Relative to Stop Codon (nt)', 'Normalized Read Depth', 'leaderless_3_nt_novel_stops_ret_2reps', 'Oranges_r')
"""
